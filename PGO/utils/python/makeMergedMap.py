...
jet_table = np.load(current_directory +'/jet_table.npy')
bone_table = np.load(current_directory +'/bone_table.npy')
...
data_dir = "/home/mathieu/Documents/pointcloud/fastlio_lc_output/28_03_2023__15_18_33/" # should end with /
scan_dir = data_dir + "scan_snapshots"
...
is_o3d_vis = True
intensity_color_max = 300

is_near_removal = True
thres_near_removal = 0.2 # meter (to remove platform-myself structure ghost points)
...
nodes_number = min(len(scan_files), len(poses))
scan_idx_range_to_stack = [0, nodes_number] # if you want a whole map, use [0, nodes_number]
